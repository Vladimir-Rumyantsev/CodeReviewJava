...
import lab3.ru.rumyantsev.geo.Path;
...
public class Main {
    ...
    public static int inputNumber(String prompt, int minVal, int maxVal) {
        ...
        while (true) {
            try {
                ...
                System.out.printf("Ошибка: Значение должно быть в диапазоне от %d до %d%n", minVal, maxVal);
    ...
    private static void demonstrateFractions() {
        while (true) {
            ...
            System.out.println("7. Умножить дробь на число");
            System.out.println("8. Клонировать дробь");
            System.out.println("9. Сравнить две дроби");
            ...
            switch (choice) {
                ...
                case 7 -> multiplyFractionByNumber();
                case 8 -> cloneFraction();
                case 9 -> compareFractions();
                case 0 -> {
                    return;
                }
            }
    ...
    private static void addPath() {
        ...
        try {
            ...
            int cost = inputNumber("Введите стоимость пути (положительное число): ", 1, Integer.MAX_VALUE);
    ...
    private static void demonstrateRoutes() {
        ...
        try {
            ...
            if (path.length == 0) {
                ...
                System.out.println("Найденный маршрут:");
